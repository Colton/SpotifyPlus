...
var Actions = function () {
  ...
  _createClass(Actions, [{
    ...
    value: function updateDescription(newDescription) {
      this.store.dispatch({
    ...
    value: function closeApp() {
      this.cosmos.resolver.post({
        url: 'sp://messages/v1/container/control',
        body: { type: 'close_modal' }
      });
    }
  }, {
    key: 'submitFeedback',
    value: function submitFeedback() {
      ...
      var userDescription = this.store.getState().feedbackReducer.userDescription;

      this.cosmos.resolver.post({
        url: 'sp://messages/v1/container/control',
        body: { type: 'send_feedback', userDescription: userDescription }
      }, function (err) {
        if (err) {
          _this.store.dispatch({ type: 'FEEDBACK_ERROR' });
        } else {
          _this.store.dispatch({ type: 'FEEDBACK_SUCCESS' });
          _this.closeApp();
        }
      });
    }
    ...
    value: function render() {
      return _react2.default.createElement(
        ...
        _react2.default.createElement(_Description2.default, {
          userDescription: this.props.feedback.userDescription,
          onChange: this.props.actions.updateDescription
        }),
        _react2.default.createElement(
          'p',
          null,
          'Your feedback, system information and diagnostic data will be submitted. This information is used to diagnose problems and help improve Spotify.'
        ),
        _react2.default.createElement(_Buttons2.default, {
          sendingFeedback: this.props.feedback.sendingFeedback,
          onCancel: this.props.actions.closeApp,
          onSubmit: this.props.actions.submitFeedback
        })
      );
    }
  }]);
...
},{"./Buttons":3,"./Description":4,"react":188}],3:[function(require,module,exports){
'use strict';
...
var Buttons = function (_React$Component) {
  ...
  _createClass(Buttons, [{
    key: 'render',
    value: function render() {
      var cancelAttributes = {
        className: 'feedback-form__cancel button button-with-stroke',
        type: 'button',
        value: 'Cancel',
      ...
      var submitAttributes = {
        className: 'feedback-form__submit button button-green',
        type: 'button',
        value: 'Send',
        onClick: this.props.onSubmit
      };

      if (this.props.sendingFeedback) {
        cancelAttributes.disabled = true;
        submitAttributes.disabled = true;
      }

      return _react2.default.createElement(
        'div',
        { className: 'feedback-form__buttons popover-footer' },
        _react2.default.createElement('input', cancelAttributes),
        _react2.default.createElement('input', submitAttributes)
      );
    }
  }]);
...
Buttons.propTypes = {
  sendingFeedback: _react2.default.PropTypes.bool,
...
var Description = function (_React$Component) {
  ...
  _createClass(Description, [{
    ...
    value: function render() {
      ...
      var textareaProps = {
        className: 'feedback-form__description-input',
        id: 'description',
        onChange: function onChange(event) {
          return _this2.props.onChange(event.target.value);
        },
        placeholder: 'What I did. What happened.',
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          'label',
          { className: 'feedback-form__description-label', htmlFor: 'description' },
          'Briefly describe the issue you encountered and any steps we can take to reproduce it.'
        ),
...
Description.propTypes = {
  ...
  userDescription: _react2.default.PropTypes.string
};
...
var actions = new _actions2.default(_store2.default, _spotifyCosmosApi2.default);
...
},{"./actions":1,"./components/App":2,"./store":7,"react":188,"react-dom":46,"react-redux":49,"spotify-cosmos-api":201}],6:[function(require,module,exports){
'use strict';
...
function feedbackReducer() {
  ...
  switch (action.type) {
    ...
    case 'UPDATE_DESCRIPTION':
      return Object.assign({}, state, { userDescription: action.description });

    case 'FEEDBACK_ATTEMPT':
      return Object.assign({}, state, { sendingFeedback: true });

    case 'FEEDBACK_SUCCESS':
      return Object.assign({}, state, { sendingFeedback: false });
...
exports.default = (0, _redux.createStore)((0, _redux.combineReducers)({ feedbackReducer: _reducer2.default }), {});

},{"./reducer":6,"redux":194}],8:[function(require,module,exports){
'use strict';
...
},{"./src/message":9,"./src/player_state":10,"./src/request":11,"./src/response":12}],9:[function(require,module,exports){
/**
...
},{"spotify-inheritance":206}],11:[function(require,module,exports){
var inherit = require('spotify-inheritance').inherit;
...
},{"./message":9,"spotify-inheritance":206}],12:[function(require,module,exports){
var inherit = require('spotify-inheritance').inherit;
...
},{"./message":9,"spotify-inheritance":206}],13:[function(require,module,exports){
'use strict';
...
},{"./emptyFunction":20}],39:[function(require,module,exports){
/**
...
},{"./_getPrototype":41,"./_isHostObject":42,"./isObjectLike":43}],45:[function(require,module,exports){
'use strict';
...
},{"react/lib/ReactDOM":89}],47:[function(require,module,exports){
'use strict';
...
},{"../utils/storeShape":51,"../utils/warning":52,"react":188}],48:[function(require,module,exports){
'use strict';
...
},{"../utils/shallowEqual":50,"../utils/storeShape":51,"../utils/warning":52,"../utils/wrapActionCreators":53,"hoist-non-react-statics":39,"invariant":40,"lodash/isPlainObject":44,"react":188}],49:[function(require,module,exports){
'use strict';
...
},{"./components/Provider":47,"./components/connect":48}],50:[function(require,module,exports){
"use strict";
...
},{"react":188}],52:[function(require,module,exports){
'use strict';
...
},{"redux":194}],54:[function(require,module,exports){
/**
...
},{"./ReactDOMComponentTree":93,"fbjs/lib/focusNode":22}],55:[function(require,module,exports){
/**
 * Copyright 2013-present Facebook, Inc.
 * All rights reserved.
 *
...
},{"./EventConstants":69,"./EventPropagators":73,"./FallbackCompositionState":74,"./SyntheticCompositionEvent":146,"./SyntheticInputEvent":150,"fbjs/lib/ExecutionEnvironment":14,"fbjs/lib/keyOf":32}],56:[function(require,module,exports){
/**
 * Copyright 2013-present, Facebook, Inc.
 * All rights reserved.
 *
...
},{"./CSSProperty":56,"./ReactInstrumentation":122,"./dangerousStyleValue":163,"fbjs/lib/ExecutionEnvironment":14,"fbjs/lib/camelizeStyleName":16,"fbjs/lib/hyphenateStyleName":27,"fbjs/lib/memoizeStringOnly":34,"fbjs/lib/warning":38}],58:[function(require,module,exports){
/**
 * Copyright 2013-present, Facebook, Inc.
 * All rights reserved.
 *
...
},{"./PooledClass":78,"fbjs/lib/invariant":28,"object-assign":45}],59:[function(require,module,exports){
/**
 * Copyright 2013-present, Facebook, Inc.
 * All rights reserved.
 *
...
},{"./EventConstants":69,"./EventPluginHub":70,"./EventPropagators":73,"./ReactDOMComponentTree":93,"./ReactUpdates":139,"./SyntheticEvent":148,"./getEventTarget":171,"./isEventSupported":178,"./isTextInputElement":179,"fbjs/lib/ExecutionEnvironment":14,"fbjs/lib/keyOf":32}],60:[function(require,module,exports){
/**
 * Copyright 2013-present, Facebook, Inc.
 * All rights reserved.
 *
...
},{"./DOMLazyTree":61,"./Danger":65,"./ReactDOMComponentTree":93,"./ReactInstrumentation":122,"./ReactMultiChildUpdateTypes":126,"./createMicrosoftUnsafeLocalFunction":162,"./setInnerHTML":183,"./setTextContent":184}],61:[function(require,module,exports){
/**
...
},{"./DOMNamespaces":62,"./createMicrosoftUnsafeLocalFunction":162,"./setTextContent":184}],62:[function(require,module,exports){
/**
 * Copyright 2013-present, Facebook, Inc.
 * All rights reserved.
 *
...
},{"fbjs/lib/invariant":28}],64:[function(require,module,exports){
/**
 * Copyright 2013-present, Facebook, Inc.
 * All rights reserved.
 *
...
},{"./DOMProperty":63,"./ReactDOMComponentTree":93,"./ReactDOMInstrumentation":101,"./ReactInstrumentation":122,"./quoteAttributeValueForBrowser":181,"fbjs/lib/warning":38}],65:[function(require,module,exports){
/**
 * Copyright 2013-present, Facebook, Inc.
 * All rights reserved.
 *
...
},{"./DOMLazyTree":61,"fbjs/lib/ExecutionEnvironment":14,"fbjs/lib/createNodesFromMarkup":19,"fbjs/lib/emptyFunction":20,"fbjs/lib/getMarkupWrap":24,"fbjs/lib/invariant":28}],66:[function(require,module,exports){
/**
 * Copyright 2013-present, Facebook, Inc.
 * All rights reserved.
 *
...
},{"fbjs/lib/keyOf":32}],67:[function(require,module,exports){
/**
 * Copyright 2013-present, Facebook, Inc.
 * All rights reserved.
 *
...
},{"./EventConstants":69,"./EventPropagators":73,"./ReactDOMComponentTree":93,"./SyntheticMouseEvent":152,"fbjs/lib/keyOf":32}],69:[function(require,module,exports){
/**
 * Copyright 2013-present, Facebook, Inc.
 * All rights reserved.
 *
...
},{"fbjs/lib/keyMirror":31}],70:[function(require,module,exports){
/**
 * Copyright 2013-present, Facebook, Inc.
 * All rights reserved.
 *
...
},{"./EventPluginRegistry":71,"./EventPluginUtils":72,"./ReactErrorUtils":115,"./accumulateInto":159,"./forEachAccumulated":167,"fbjs/lib/invariant":28}],71:[function(require,module,exports){
/**
 * Copyright 2013-present, Facebook, Inc.
 * All rights reserved.
 *
...
},{"fbjs/lib/invariant":28}],72:[function(require,module,exports){
/**
 * Copyright 2013-present, Facebook, Inc.
 * All rights reserved.
 *
...
},{"./EventConstants":69,"./ReactErrorUtils":115,"fbjs/lib/invariant":28,"fbjs/lib/warning":38}],73:[function(require,module,exports){
/**
 * Copyright 2013-present, Facebook, Inc.
 * All rights reserved.
 *
...
},{"./EventConstants":69,"./EventPluginHub":70,"./EventPluginUtils":72,"./accumulateInto":159,"./forEachAccumulated":167,"fbjs/lib/warning":38}],74:[function(require,module,exports){
/**
 * Copyright 2013-present, Facebook, Inc.
 * All rights reserved.
 *
...
},{"./PooledClass":78,"./getTextContentAccessor":175,"object-assign":45}],75:[function(require,module,exports){
/**
 * Copyright 2013-present, Facebook, Inc.
 * All rights reserved.
 *
...
},{"./DOMProperty":63}],76:[function(require,module,exports){
/**
 * Copyright 2013-present, Facebook, Inc.
 * All rights reserved.
 *
...
},{"./ReactPropTypeLocations":132,"./ReactPropTypes":133,"fbjs/lib/invariant":28,"fbjs/lib/warning":38}],78:[function(require,module,exports){
/**
 * Copyright 2013-present, Facebook, Inc.
 * All rights reserved.
 *
...
},{"fbjs/lib/invariant":28}],79:[function(require,module,exports){
/**
 * Copyright 2013-present, Facebook, Inc.
 * All rights reserved.
 *
...
},{"./ReactChildren":82,"./ReactClass":83,"./ReactComponent":84,"./ReactDOMFactories":97,"./ReactElement":112,"./ReactElementValidator":113,"./ReactPropTypes":133,"./ReactVersion":140,"./onlyChild":180,"fbjs/lib/warning":38,"object-assign":45}],80:[function(require,module,exports){
/**
 * Copyright 2013-present, Facebook, Inc.
 * All rights reserved.
 *
...
},{"./EventConstants":69,"./EventPluginRegistry":71,"./ReactEventEmitterMixin":116,"./ViewportMetrics":158,"./getVendorPrefixedEventName":176,"./isEventSupported":178,"object-assign":45}],81:[function(require,module,exports){
/**
...
},{"./KeyEscapeUtils":76,"./ReactReconciler":135,"./instantiateReactComponent":177,"./shouldUpdateReactComponent":185,"./traverseAllChildren":186,"fbjs/lib/warning":38}],82:[function(require,module,exports){
/**
 * Copyright 2013-present, Facebook, Inc.
 * All rights reserved.
 *
...
},{"./PooledClass":78,"./ReactElement":112,"./traverseAllChildren":186,"fbjs/lib/emptyFunction":20}],83:[function(require,module,exports){
/**
 * Copyright 2013-present, Facebook, Inc.
 * All rights reserved.
 *
...
},{"./ReactComponent":84,"./ReactElement":112,"./ReactNoopUpdateQueue":129,"./ReactPropTypeLocationNames":131,"./ReactPropTypeLocations":132,"fbjs/lib/emptyObject":21,"fbjs/lib/invariant":28,"fbjs/lib/keyMirror":31,"fbjs/lib/keyOf":32,"fbjs/lib/warning":38,"object-assign":45}],84:[function(require,module,exports){
/**
 * Copyright 2013-present, Facebook, Inc.
 * All rights reserved.
 *
...
},{"./ReactInstrumentation":122,"./ReactNoopUpdateQueue":129,"./canDefineProperty":161,"fbjs/lib/emptyObject":21,"fbjs/lib/invariant":28,"fbjs/lib/warning":38}],85:[function(require,module,exports){
/**
 * Copyright 2013-present, Facebook, Inc.
 * All rights reserved.
 *
...
},{"./DOMChildrenOperations":60,"./ReactDOMIDOperations":99}],86:[function(require,module,exports){
/**
 * Copyright 2014-present, Facebook, Inc.
 * All rights reserved.
 *
...
},{"fbjs/lib/invariant":28}],87:[function(require,module,exports){
/**
 * Copyright 2013-present, Facebook, Inc.
 * All rights reserved.
 *
...
},{"./ReactComponentEnvironment":86,"./ReactCurrentOwner":88,"./ReactElement":112,"./ReactErrorUtils":115,"./ReactInstanceMap":121,"./ReactInstrumentation":122,"./ReactNodeTypes":128,"./ReactPropTypeLocationNames":131,"./ReactPropTypeLocations":132,"./ReactReconciler":135,"./ReactUpdateQueue":138,"./shouldUpdateReactComponent":185,"fbjs/lib/emptyObject":21,"fbjs/lib/invariant":28,"fbjs/lib/warning":38,"object-assign":45}],88:[function(require,module,exports){
/**
 * Copyright 2013-present, Facebook, Inc.
 * All rights reserved.
 *
...
module.exports = React;
},{"./ReactDOMComponentTree":93,"./ReactDefaultInjection":111,"./ReactMount":124,"./ReactReconciler":135,"./ReactUpdates":139,"./ReactVersion":140,"./findDOMNode":165,"./getNativeComponentFromComposite":173,"./renderSubtreeIntoContainer":182,"fbjs/lib/warning":38}],90:[function(require,module,exports){
/**
 * Copyright 2013-present, Facebook, Inc.
 * All rights reserved.
 *
...
},{"./DisabledInputUtils":67}],91:[function(require,module,exports){
/**
 * Copyright 2013-present, Facebook, Inc.
 * All rights reserved.
 *
...
},{"./AutoFocusUtils":54,"./CSSPropertyOperations":57,"./DOMLazyTree":61,"./DOMNamespaces":62,"./DOMProperty":63,"./DOMPropertyOperations":64,"./EventConstants":69,"./EventPluginHub":70,"./EventPluginRegistry":71,"./ReactBrowserEventEmitter":80,"./ReactComponentBrowserEnvironment":85,"./ReactDOMButton":90,"./ReactDOMComponentFlags":92,"./ReactDOMComponentTree":93,"./ReactDOMInput":100,"./ReactDOMOption":102,"./ReactDOMSelect":103,"./ReactDOMTextarea":106,"./ReactInstrumentation":122,"./ReactMultiChild":125,"./ReactServerRenderingTransaction":137,"./escapeTextContentForBrowser":164,"./isEventSupported":178,"./validateDOMNesting":187,"fbjs/lib/emptyFunction":20,"fbjs/lib/invariant":28,"fbjs/lib/keyOf":32,"fbjs/lib/shallowEqual":37,"fbjs/lib/warning":38,"object-assign":45}],92:[function(require,module,exports){
/**
 * Copyright 2015-present, Facebook, Inc.
 * All rights reserved.
 *
...
},{"./DOMProperty":63,"./ReactDOMComponentFlags":92,"fbjs/lib/invariant":28}],94:[function(require,module,exports){
/**
 * Copyright 2013-present, Facebook, Inc.
 * All rights reserved.
 *
...
},{"./validateDOMNesting":187}],95:[function(require,module,exports){
/**
 * Copyright 2013-present, Facebook, Inc.
 * All rights reserved.
 *
...
},{"./ReactDOMUnknownPropertyDevtool":108,"fbjs/lib/warning":38}],96:[function(require,module,exports){
/**
 * Copyright 2014-present, Facebook, Inc.
 * All rights reserved.
 *
...
},{"./DOMLazyTree":61,"./ReactDOMComponentTree":93,"object-assign":45}],97:[function(require,module,exports){
/**
 * Copyright 2013-present, Facebook, Inc.
 * All rights reserved.
 *
...
},{"./ReactElement":112,"./ReactElementValidator":113,"fbjs/lib/mapObject":33}],98:[function(require,module,exports){
/**
 * Copyright 2013-present, Facebook, Inc.
 * All rights reserved.
 *
...
},{"./DOMChildrenOperations":60,"./ReactDOMComponentTree":93}],100:[function(require,module,exports){
/**
 * Copyright 2013-present, Facebook, Inc.
 * All rights reserved.
 *
...
},{"./DOMPropertyOperations":64,"./DisabledInputUtils":67,"./LinkedValueUtils":77,"./ReactDOMComponentTree":93,"./ReactUpdates":139,"fbjs/lib/invariant":28,"fbjs/lib/warning":38,"object-assign":45}],101:[function(require,module,exports){
/**
 * Copyright 2013-present, Facebook, Inc.
 * All rights reserved.
 *
...
},{"./ReactDOMDebugTool":95}],102:[function(require,module,exports){
/**
 * Copyright 2013-present, Facebook, Inc.
 * All rights reserved.
 *
...
},{"./ReactChildren":82,"./ReactDOMComponentTree":93,"./ReactDOMSelect":103,"fbjs/lib/warning":38,"object-assign":45}],103:[function(require,module,exports){
/**
 * Copyright 2013-present, Facebook, Inc.
 * All rights reserved.
 *
...
},{"./DisabledInputUtils":67,"./LinkedValueUtils":77,"./ReactDOMComponentTree":93,"./ReactUpdates":139,"fbjs/lib/warning":38,"object-assign":45}],104:[function(require,module,exports){
/**
 * Copyright 2013-present, Facebook, Inc.
 * All rights reserved.
 *
...
},{"./getNodeForCharacterOffset":174,"./getTextContentAccessor":175,"fbjs/lib/ExecutionEnvironment":14}],105:[function(require,module,exports){
/**
 * Copyright 2013-present, Facebook, Inc.
 * All rights reserved.
 *
...
},{"./DOMChildrenOperations":60,"./DOMLazyTree":61,"./ReactDOMComponentTree":93,"./ReactInstrumentation":122,"./escapeTextContentForBrowser":164,"./validateDOMNesting":187,"fbjs/lib/invariant":28,"object-assign":45}],106:[function(require,module,exports){
/**
 * Copyright 2013-present, Facebook, Inc.
 * All rights reserved.
 *
...
},{"./DOMPropertyOperations":64,"./DisabledInputUtils":67,"./LinkedValueUtils":77,"./ReactDOMComponentTree":93,"./ReactUpdates":139,"fbjs/lib/invariant":28,"fbjs/lib/warning":38,"object-assign":45}],107:[function(require,module,exports){
/**
 * Copyright 2015-present, Facebook, Inc.
 * All rights reserved.
 *
...
},{"fbjs/lib/invariant":28}],108:[function(require,module,exports){
/**
 * Copyright 2013-present, Facebook, Inc.
 * All rights reserved.
 *
...
},{"./DOMProperty":63,"./EventPluginRegistry":71,"fbjs/lib/warning":38}],109:[function(require,module,exports){
/**
...
},{"fbjs/lib/ExecutionEnvironment":14,"fbjs/lib/performanceNow":36,"fbjs/lib/warning":38}],110:[function(require,module,exports){
/**
 * Copyright 2013-present, Facebook, Inc.
 * All rights reserved.
 *
...
},{"./ReactUpdates":139,"./Transaction":157,"fbjs/lib/emptyFunction":20,"object-assign":45}],111:[function(require,module,exports){
/**
 * Copyright 2013-present, Facebook, Inc.
 * All rights reserved.
 *
...
},{"./BeforeInputEventPlugin":55,"./ChangeEventPlugin":59,"./DefaultEventPluginOrder":66,"./EnterLeaveEventPlugin":68,"./HTMLDOMPropertyConfig":75,"./ReactComponentBrowserEnvironment":85,"./ReactDOMComponent":91,"./ReactDOMComponentTree":93,"./ReactDOMEmptyComponent":96,"./ReactDOMTextComponent":105,"./ReactDOMTreeTraversal":107,"./ReactDefaultBatchingStrategy":110,"./ReactEventListener":117,"./ReactInjection":119,"./ReactReconcileTransaction":134,"./SVGDOMPropertyConfig":141,"./SelectEventPlugin":142,"./SimpleEventPlugin":143}],112:[function(require,module,exports){
/**
 * Copyright 2014-present, Facebook, Inc.
 * All rights reserved.
 *
...
},{"./ReactCurrentOwner":88,"./canDefineProperty":161,"fbjs/lib/warning":38,"object-assign":45}],113:[function(require,module,exports){
/**
 * Copyright 2014-present, Facebook, Inc.
 * All rights reserved.
 *
...
},{"./ReactCurrentOwner":88,"./ReactElement":112,"./ReactPropTypeLocationNames":131,"./ReactPropTypeLocations":132,"./canDefineProperty":161,"./getIteratorFn":172,"fbjs/lib/invariant":28,"fbjs/lib/warning":38}],114:[function(require,module,exports){
/**
 * Copyright 2014-present, Facebook, Inc.
 * All rights reserved.
 *
...
},{"./EventPluginHub":70}],117:[function(require,module,exports){
/**
 * Copyright 2013-present, Facebook, Inc.
 * All rights reserved.
 *
...
},{"./PooledClass":78,"./ReactDOMComponentTree":93,"./ReactUpdates":139,"./getEventTarget":171,"fbjs/lib/EventListener":13,"fbjs/lib/ExecutionEnvironment":14,"fbjs/lib/getUnboundedScrollPosition":25,"object-assign":45}],118:[function(require,module,exports){
/**
 * Copyright 2013-present, Facebook, Inc.
 * All rights reserved.
 *
...
},{"./DOMProperty":63,"./EventPluginHub":70,"./EventPluginUtils":72,"./ReactBrowserEventEmitter":80,"./ReactClass":83,"./ReactComponentEnvironment":86,"./ReactEmptyComponent":114,"./ReactNativeComponent":127,"./ReactUpdates":139}],120:[function(require,module,exports){
/**
 * Copyright 2013-present, Facebook, Inc.
 * All rights reserved.
 *
...
},{"./ReactDOMSelection":104,"fbjs/lib/containsNode":17,"fbjs/lib/focusNode":22,"fbjs/lib/getActiveElement":23}],121:[function(require,module,exports){
/**
 * Copyright 2013-present, Facebook, Inc.
 * All rights reserved.
 *
...
},{"./ReactDebugTool":109}],123:[function(require,module,exports){
/**
 * Copyright 2013-present, Facebook, Inc.
 * All rights reserved.
 *
...
},{"./adler32":160}],124:[function(require,module,exports){
/**
 * Copyright 2013-present, Facebook, Inc.
 * All rights reserved.
 *
...
},{"./DOMLazyTree":61,"./DOMProperty":63,"./ReactBrowserEventEmitter":80,"./ReactCurrentOwner":88,"./ReactDOMComponentTree":93,"./ReactDOMContainerInfo":94,"./ReactDOMFeatureFlags":98,"./ReactElement":112,"./ReactFeatureFlags":118,"./ReactInstrumentation":122,"./ReactMarkupChecksum":123,"./ReactReconciler":135,"./ReactUpdateQueue":138,"./ReactUpdates":139,"./instantiateReactComponent":177,"./setInnerHTML":183,"./shouldUpdateReactComponent":185,"fbjs/lib/emptyObject":21,"fbjs/lib/invariant":28,"fbjs/lib/warning":38}],125:[function(require,module,exports){
/**
 * Copyright 2013-present, Facebook, Inc.
 * All rights reserved.
 *
...
},{"./ReactChildReconciler":81,"./ReactComponentEnvironment":86,"./ReactCurrentOwner":88,"./ReactInstrumentation":122,"./ReactMultiChildUpdateTypes":126,"./ReactReconciler":135,"./flattenChildren":166,"fbjs/lib/emptyFunction":20,"fbjs/lib/invariant":28}],126:[function(require,module,exports){
/**
 * Copyright 2013-present, Facebook, Inc.
 * All rights reserved.
 *
...
},{"fbjs/lib/keyMirror":31}],127:[function(require,module,exports){
/**
 * Copyright 2014-present, Facebook, Inc.
 * All rights reserved.
 *
...
},{"fbjs/lib/invariant":28,"object-assign":45}],128:[function(require,module,exports){
/**
 * Copyright 2013-present, Facebook, Inc.
 * All rights reserved.
 *
...
},{"./ReactElement":112,"fbjs/lib/invariant":28}],129:[function(require,module,exports){
/**
 * Copyright 2015-present, Facebook, Inc.
 * All rights reserved.
 *
...
},{"fbjs/lib/warning":38}],130:[function(require,module,exports){
/**
 * Copyright 2013-present, Facebook, Inc.
 * All rights reserved.
 *
...
},{"fbjs/lib/invariant":28}],131:[function(require,module,exports){
/**
 * Copyright 2013-present, Facebook, Inc.
 * All rights reserved.
 *
...
},{"fbjs/lib/keyMirror":31}],133:[function(require,module,exports){
/**
 * Copyright 2013-present, Facebook, Inc.
 * All rights reserved.
 *
...
},{"./ReactElement":112,"./ReactPropTypeLocationNames":131,"./getIteratorFn":172,"fbjs/lib/emptyFunction":20}],134:[function(require,module,exports){
/**
 * Copyright 2013-present, Facebook, Inc.
 * All rights reserved.
 *
...
},{"./CallbackQueue":58,"./PooledClass":78,"./ReactBrowserEventEmitter":80,"./ReactInputSelection":120,"./Transaction":157,"object-assign":45}],135:[function(require,module,exports){
/**
 * Copyright 2013-present, Facebook, Inc.
 * All rights reserved.
 *
...
},{"./ReactInstrumentation":122,"./ReactRef":136,"fbjs/lib/invariant":28}],136:[function(require,module,exports){
/**
 * Copyright 2013-present, Facebook, Inc.
 * All rights reserved.
 *
...
},{"./ReactOwner":130}],137:[function(require,module,exports){
/**
 * Copyright 2014-present, Facebook, Inc.
 * All rights reserved.
 *
...
},{"./PooledClass":78,"./Transaction":157,"object-assign":45}],138:[function(require,module,exports){
/**
 * Copyright 2015-present, Facebook, Inc.
 * All rights reserved.
 *
...
},{"./ReactCurrentOwner":88,"./ReactInstanceMap":121,"./ReactUpdates":139,"fbjs/lib/invariant":28,"fbjs/lib/warning":38}],139:[function(require,module,exports){
/**
 * Copyright 2013-present, Facebook, Inc.
 * All rights reserved.
 *
...
},{"./CallbackQueue":58,"./PooledClass":78,"./ReactFeatureFlags":118,"./ReactInstrumentation":122,"./ReactReconciler":135,"./Transaction":157,"fbjs/lib/invariant":28,"object-assign":45}],140:[function(require,module,exports){
/**
 * Copyright 2013-present, Facebook, Inc.
 * All rights reserved.
 *
...
},{"./EventConstants":69,"./EventPropagators":73,"./ReactDOMComponentTree":93,"./ReactInputSelection":120,"./SyntheticEvent":148,"./isTextInputElement":179,"fbjs/lib/ExecutionEnvironment":14,"fbjs/lib/getActiveElement":23,"fbjs/lib/keyOf":32,"fbjs/lib/shallowEqual":37}],143:[function(require,module,exports){
/**
 * Copyright 2013-present, Facebook, Inc.
 * All rights reserved.
 *
...
},{"./EventConstants":69,"./EventPropagators":73,"./ReactDOMComponentTree":93,"./SyntheticAnimationEvent":144,"./SyntheticClipboardEvent":145,"./SyntheticDragEvent":147,"./SyntheticEvent":148,"./SyntheticFocusEvent":149,"./SyntheticKeyboardEvent":151,"./SyntheticMouseEvent":152,"./SyntheticTouchEvent":153,"./SyntheticTransitionEvent":154,"./SyntheticUIEvent":155,"./SyntheticWheelEvent":156,"./getEventCharCode":168,"fbjs/lib/EventListener":13,"fbjs/lib/emptyFunction":20,"fbjs/lib/invariant":28,"fbjs/lib/keyOf":32}],144:[function(require,module,exports){
/**
 * Copyright 2013-present, Facebook, Inc.
 * All rights reserved.
 *
...
},{"./PooledClass":78,"fbjs/lib/emptyFunction":20,"fbjs/lib/warning":38,"object-assign":45}],149:[function(require,module,exports){
/**
 * Copyright 2013-present, Facebook, Inc.
 * All rights reserved.
 *
...
},{"./SyntheticUIEvent":155,"./getEventCharCode":168,"./getEventKey":169,"./getEventModifierState":170}],152:[function(require,module,exports){
/**
 * Copyright 2013-present, Facebook, Inc.
 * All rights reserved.
 *
...
},{"./SyntheticUIEvent":155,"./ViewportMetrics":158,"./getEventModifierState":170}],153:[function(require,module,exports){
/**
 * Copyright 2013-present, Facebook, Inc.
 * All rights reserved.
 *
...
},{"./SyntheticUIEvent":155,"./getEventModifierState":170}],154:[function(require,module,exports){
/**
 * Copyright 2013-present, Facebook, Inc.
 * All rights reserved.
 *
...
},{"./SyntheticEvent":148,"./getEventTarget":171}],156:[function(require,module,exports){
/**
 * Copyright 2013-present, Facebook, Inc.
 * All rights reserved.
 *
...
},{"fbjs/lib/invariant":28}],158:[function(require,module,exports){
/**
 * Copyright 2013-present, Facebook, Inc.
 * All rights reserved.
 *
...
},{"fbjs/lib/invariant":28}],160:[function(require,module,exports){
/**
 * Copyright 2013-present, Facebook, Inc.
 * All rights reserved.
 *
...
},{"./CSSProperty":56,"fbjs/lib/warning":38}],164:[function(require,module,exports){
/**
 * Copyright 2013-present, Facebook, Inc.
 * All rights reserved.
 *
...
},{"./ReactCurrentOwner":88,"./ReactDOMComponentTree":93,"./ReactInstanceMap":121,"./getNativeComponentFromComposite":173,"fbjs/lib/invariant":28,"fbjs/lib/warning":38}],166:[function(require,module,exports){
/**
 * Copyright 2013-present, Facebook, Inc.
 * All rights reserved.
 *
...
},{"./KeyEscapeUtils":76,"./traverseAllChildren":186,"fbjs/lib/warning":38}],167:[function(require,module,exports){
/**
 * Copyright 2013-present, Facebook, Inc.
 * All rights reserved.
 *
...
},{"./getEventCharCode":168}],170:[function(require,module,exports){
/**
 * Copyright 2013-present, Facebook, Inc.
 * All rights reserved.
 *
...
},{"./ReactNodeTypes":128}],174:[function(require,module,exports){
/**
 * Copyright 2013-present, Facebook, Inc.
 * All rights reserved.
 *
...
},{"fbjs/lib/ExecutionEnvironment":14}],176:[function(require,module,exports){
/**
 * Copyright 2013-present, Facebook, Inc.
 * All rights reserved.
 *
...
},{"fbjs/lib/ExecutionEnvironment":14}],177:[function(require,module,exports){
/**
 * Copyright 2013-present, Facebook, Inc.
 * All rights reserved.
 *
...
},{"./ReactCompositeComponent":87,"./ReactEmptyComponent":114,"./ReactInstrumentation":122,"./ReactNativeComponent":127,"fbjs/lib/invariant":28,"fbjs/lib/warning":38,"object-assign":45}],178:[function(require,module,exports){
/**
 * Copyright 2013-present, Facebook, Inc.
 * All rights reserved.
 *
...
},{"./ReactElement":112,"fbjs/lib/invariant":28}],181:[function(require,module,exports){
/**
 * Copyright 2013-present, Facebook, Inc.
 * All rights reserved.
 *
...
},{"./escapeTextContentForBrowser":164}],182:[function(require,module,exports){
/**
 * Copyright 2013-present, Facebook, Inc.
 * All rights reserved.
 *
...
},{"./createMicrosoftUnsafeLocalFunction":162,"fbjs/lib/ExecutionEnvironment":14}],184:[function(require,module,exports){
/**
 * Copyright 2013-present, Facebook, Inc.
 * All rights reserved.
 *
...
},{"./escapeTextContentForBrowser":164,"./setInnerHTML":183,"fbjs/lib/ExecutionEnvironment":14}],185:[function(require,module,exports){
/**
 * Copyright 2013-present, Facebook, Inc.
 * All rights reserved.
 *
...
},{"./KeyEscapeUtils":76,"./ReactCurrentOwner":88,"./ReactElement":112,"./getIteratorFn":172,"fbjs/lib/invariant":28,"fbjs/lib/warning":38}],187:[function(require,module,exports){
/**
 * Copyright 2015-present, Facebook, Inc.
 * All rights reserved.
 *
...
},{"fbjs/lib/emptyFunction":20,"fbjs/lib/warning":38,"object-assign":45}],188:[function(require,module,exports){
'use strict';

module.exports = require('./lib/React');

},{"./lib/React":79}],189:[function(require,module,exports){
'use strict';
...
},{"./createStore":193,"./utils/warning":195,"lodash/isPlainObject":44}],192:[function(require,module,exports){
"use strict";
...
},{"lodash/isPlainObject":44,"symbol-observable":208}],194:[function(require,module,exports){
'use strict';
...
},{"./applyMiddleware":189,"./bindActionCreators":190,"./combineReducers":191,"./compose":192,"./createStore":193,"./utils/warning":195}],195:[function(require,module,exports){
'use strict';
...
},{"./request":200}],197:[function(require,module,exports){
(function (global){
/*jslint node: true */
...
},{"./bootstrap":196,"spotify-deferred":203}],198:[function(require,module,exports){
(function (global){
/*jslint node: true */
...
},{"./bootstrap":196,"spotify-deferred":203}],199:[function(require,module,exports){
(function (global){
/*jslint node: true */
...
},{"./bootstrap":196,"spotify-deferred":203}],200:[function(require,module,exports){
/*jslint node: true */
...
},{"spotify-deferred":203}],201:[function(require,module,exports){
(function (global){
'use strict';
...
},{"./env/bootstrap.mock.js":197,"./env/bootstrap.native.js":198,"./env/bootstrap.web.js":199,"./scripts/resolver":204,"cosmos-common-js":8}],202:[function(require,module,exports){
/**
 * @file
...
},{"spotify-postrouter":202}],204:[function(require,module,exports){
var common = require('cosmos-common-js');
...
},{"cosmos-common-js":8}],205:[function(require,module,exports){
'use strict';
...
},{"./extend":205,"./inherit":207}],207:[function(require,module,exports){
'use strict';
